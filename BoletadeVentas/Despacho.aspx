...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        function SectorOficina() {
            $.ajax({
                ...
                success: function (msg) {
                    alert(nota);
                    if (msg.d) {
                        alert('Operación terminada. Valide resultado en la vista');
                        var objBoton = '<%=btnAux.ClientID%>';
                        var boton = document.getElementById(objBoton);
                        boton.click();
                        $(this).dialog("close");
    ...
    <br />
       ...
       <td colspan="4" style="height:40px">
        <ul id="nav">
                    ...
                    <li class="top">
                        <asp:LinkButton ID="acusete" runat="server" CssClass="top_link" onclick="acusete_Click"
                            >Informe Acciones</asp:LinkButton></li>
                </ul>
       </td>
       </tr>
       </table>
    ...
    <asp:GridView ID="gvDespacho" runat="server" AutoGenerateColumns="False" CellPadding="4"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Docto" SortExpression="Docto">
                <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Rec" SortExpression="Rec">
                <ItemTemplate>
                    <asp:ImageButton  AlternateText=" " ImageUrl='<%#Bind("ok") %>' runat="server" ID="imgReci" 
            ...
            <asp:TemplateField HeaderText="Conductor" SortExpression="Conductor">
                <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Estado">
                <ItemTemplate>
                    <asp:ImageButton  AlternateText=" " runat="server" ID="imgBEstado" ImageUrl='<%#Eval("estado") %>' />
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Depachador" SortExpression="Depachador">
            <ItemTemplate>
